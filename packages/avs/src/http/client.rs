...
pub async fn send<B: Body>(req: Request<B>) -> Result<Response<IncomingBody>> {
    ...
    io::copy(body, OutputStream::new(reactor, body_stream))
        .await
    ...
    reactor.wait_for(res.subscribe()).await;
    ...
    Response::try_from_incoming_response(res)
}
